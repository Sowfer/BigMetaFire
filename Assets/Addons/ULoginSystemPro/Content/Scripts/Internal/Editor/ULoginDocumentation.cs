...
public class ULoginDocumentation : TutorialWizard
{
   ...
   // public ULoginFileUploader fileUploader;
    ...
    void DrawRequire()
    {
        ...
        DrawHorizontalColumn("Domain", "domain is the address where Internet users can access your website or hosting files, for example: <i>lovattostudio.com</i>");
        ...
        DrawText("For some platforms like iOS and Android an valid SSL Certificated <i>(https)</i> is needed.");
        DownArrow();
        DrawText("if you have or had a web site, you may be familiar with these requirements, if not you'll learn how to obtain these for free in the following steps.");
        GUILayout.Space(15);
    }
