...
#if UNITY_EDITOR
using UnityEditor;
using HyperlinkText = MFPSEditor.TutorialWizard.HyperlinkText;
#endif
...
namespace MFPSEditor.Addons
{
        ...
        public void OnLoad()
        {
            ...
            if (MFPSAddonsData.Instance != null)
            {
                ...
                if (i >= 0 && MFPSAddonsData.Instance.Addons[i].Info == null)
                {
                    ...
                    LovattoStats.SetStat($"addon-{Name}", 1);
                }
            }
        }
#endif
    ...
    public class MFPSAddonsEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                rect = r;
                TutorialWizard.Style.DrawGlowRect(r, MFPSEditorStyles.LovattoEditorPalette.GetBackgroundColor(), Color.white);
                ...
                GUILayout.Space(25);
                if (TutorialWizard.Buttons.GlowButton("ADDONS MANAGER", Color.black, GUILayout.Height(EditorGUIUtility.singleLineHeight)))
                {
